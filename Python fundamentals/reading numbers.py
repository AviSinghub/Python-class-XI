...
marks = float(input('Enter marks:'))        #the function int() around input() converts the read value into integer type. 
print(type(marks))

age = int(input('Enter age:'))              #the function float() around input() converts the read value into float type. 
print(type(age))
